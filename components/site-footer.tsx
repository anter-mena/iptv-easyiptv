      ...
      <div className="mx-auto max-w-7xl px-4 pt-12 pb-8 sm:px-6 lg:px-8">
            ...
            <div className="mb-6 flex flex-col items-center space-y-4 lg:items-start">
              <div className="flex items-center space-x-3 group">
                ...
                <div className="text-left">
                  <div className="text-xs font-bold text-white uppercase tracking-wider">Premium Security</div>
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <div className="text-left">
                  <div className="text-xs font-bold text-white uppercase tracking-wider">Elite Support</div>
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <ul className="space-y-4 text-center lg:text-left">
              {[
                ...
                { name: "FAQ", href: "/#faq" }, // Assuming FAQ section on home page
                { name: "Troubleshooting", href: "/installation-guide" },
                { name: "Request Channel", href: "/contact" },
              ].map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="group relative flex items-center justify-center lg:justify-start text-sm text-gray-400 transition-colors hover:text-iptv-green">
                    <span className="relative pb-0.5 after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-iptv-green after:transition-all group-hover:after:w-full">
            ...
            <div className="mb-6 flex flex-col items-center space-y-4 lg:items-start">
              <div className="flex flex-col items-center space-x-3 text-center sm:flex-row sm:text-left">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400">support@easyiptv.com</div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center space-x-3 text-center sm:flex-row sm:text-left">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-400">24/7 Live Chat</div>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
                ...
                <div className="hidden lg:flex lg:gap-1">
                  <input
                    ...
                    className="flex-1 rounded-md border border-gray-600 bg-[#444444] px-2 py-1 text-xs text-white placeholder-gray-400 transition-all focus:outline-none"
                  />
                  <button
                    type="submit"
                    disabled={status === "loading"}
        ...
        <div className="border-t border-[#333333] pt-8">
          <div className="grid grid-cols-1 items-center lg:grid-cols-3">
            ...
            {/* Legal Links */}
            <div className="flex flex-wrap justify-center space-x-6 py-4 lg:py-0">
              <Link href="/about" className="text-sm text-gray-400 transition-colors hover:text-iptv-green">
                Privacy Policy
              </Link>
              <Link href="/about" className="text-sm text-gray-400 transition-colors hover:text-iptv-green">
                Terms of Service
