    ...
    <div className="fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-white p-6 text-center overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col gap-4 sm:flex-row justify-center">
          <button
            onClick={handleBack}
            className="rounded-md bg-red-600 px-6 py-2.5 text-sm font-bold text-white shadow-xl transition-all hover:scale-105 hover:bg-red-700 ring-4 ring-red-600/20 flex items-center justify-center"
          >
